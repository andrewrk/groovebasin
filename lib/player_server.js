...
PlayerServer.prototype.initialize = function() {
  ...
  var onConnectedUsersUpdate = addSubscription('connectedUsers', getConnectedUsers);
  self.on('connectedUsers', onConnectedUsersUpdate);
  self.player.on('streamerConnect', onConnectedUsersUpdate);
  self.player.on('streamerDisconnect', onConnectedUsersUpdate);
