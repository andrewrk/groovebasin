...
PlayerServer.prototype.initialize = function() {
  ...
  self.player.on('labelAdd',    onLibraryUpdate);
  self.player.on('labelRemove', onLibraryUpdate);
...
PlayerServer.prototype.labelRename = function(client, id, name) {
  this.addEvent({
    user: client.user,
    type: 'labelRename',
    id: id,
  ...
  this.player.labelRename(id, name);
};

PlayerServer.prototype.labelDelete = function(client, ids) {
  this.addEvent({
    user: client.user,
    type: 'labelDelete',
    ids: ids,
  });
  this.player.labelDelete(ids);
};
