...
Player.prototype.importUrl = function(urlString, cb) {
  ...
  function tryImportFilter() {
    ...
    function callNextFilter(err, dlStream, filenameHintWithoutPath) {
      ...
      self.importStream(dlStream, filenameHintWithoutPath, cb);
    }
  }
...
Player.prototype.importStream = function(readStream, filenameHintWithoutPath, cb) {
  var self = this;
    ...
    function onEntry(entry) {
      ...
      pend.go(function(cb) {
        zipfile.openReadStream(entry, function(err, readStream) {
          ...
          self.importStream(readStream, entryBaseName, function(err, dbFiles) {
            if (err) {
