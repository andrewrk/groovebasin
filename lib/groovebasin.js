...
GrooveBasin.prototype.initializeDownload = function() {
  ...
  self.app.post('/download/custom', self.hasPermRead, bodyParser(), function(req, resp) {
...
GrooveBasin.prototype.initializeUpload = function() {
  var self = this;
  self.app.post('/upload', self.hasPermControl, function(request, response, next) {
...
GrooveBasin.prototype.startServer = function() {
  ...
  self.hasPermControl = self.createHasPermMiddleware('control');
