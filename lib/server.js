      ...
      db.open(function(err) {
        ...
        pend.wait(function(err) {
          ...
          var player = new Player(db, config.musicDirectory,
            config.encodeQueueDuration, config.googleApiKey, config.encodeBitRate, config.encodeFormat);
...
function initializeStream(app, player, hasPermRead) {
  app.get(player.getStreamEndpoint(), hasPermRead, function(req, resp, next) {
    resp.setHeader('Content-Type', player.getStreamMimeType());
