...
PlayerServer.prototype.addEvent = function(user, type, text, trackId) {
  ...
  if (extraEvents > 0) {
    ...
    for (i = 0; i < extraEvents; i += 1) {
      ...
      userId = thisEvent.user && thisEvent.user.id;
      if (userId) {
        scrubUserIds[userId] = true;
      }
