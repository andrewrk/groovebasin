...
var commands = {
  ...
  "playid": {
    permission: 'control',
    fn: function (self, socket, args, cb) {
      var id = args.songId == null ? self.gb.player.tracksInOrder[0].id : args.songId;
...
function deleteCmd(self, socket, args, cb) {
  cb(ERR_CODE_UNKNOWN, "unimplemented");
}
...
function moveCmd(self, socket, args, cb) {
  cb(ERR_CODE_UNKNOWN, "unimplemented");
}

function moveidCmd(self, socket, args, cb) {
  cb(ERR_CODE_UNKNOWN, "unimplemented");
}
...
function repeatCmd(self, socket, args, cb) {
  cb(ERR_CODE_UNKNOWN, "unimplemented");
}
