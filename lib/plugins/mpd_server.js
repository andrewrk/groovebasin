...
var commands = {
  ...
  "find": {
    ...
    fn: function (self, socket, args, cb) {
      findOrSearch(self, socket, args, true, cb);
    },
  },
  "findadd": {
    permission: 'control',
    manualArgParsing: true,
    fn: function (self, socket, args, cb) {
      findOrSearchAdd(self, socket, args, true, cb);
    },
  },
  ...
  "search": {
    ...
    manualArgParsing: true,
    fn: function (self, socket, args, cb) {
      findOrSearch(self, socket, args, false, cb);
    },
  },
  "searchadd": {
    permission: 'add',
    manualArgParsing: true,
    fn: function (self, socket, args, cb) {
      findOrSearchAdd(self, socket, args, false, cb);
    },
  },
  "searchaddpl": {
    permission: 'control',
...
function findOrSearch(self, socket, args, caseSensitive, cb) {
...
function findOrSearchAdd(self, socket, args, caseSensitive, cb) {
  var keys = [];
