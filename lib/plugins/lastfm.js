...
function onSocketConnection(socket) {
  ...
  socket.emit('LastFmApiKey', self.gb.config.lastFmApiKey);
    ...
    self.lastFm.request("auth.getSession", {
      ...
      handlers: {
        success: function(data){
          ...
          socket.emit('LastFmGetSessionSuccess', data);
        },
        error: function(error){
          console.error("error from last.fm auth.getSession:", error.message);
          socket.emit('LastFmGetSessionError', error.message);
        }
      }
    });
  });

  socket.on('LastFmScrobblersAdd', function(params) {
  ...
  socket.on('LastFmScrobblersRemove', function(params) {
